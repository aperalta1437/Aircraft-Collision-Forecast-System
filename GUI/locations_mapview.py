...
class LocationsMapView(MapView):
    ...
    def get_locations_in_fov(self, *args, airport_focus=False, airplane_focus=False):
        ...
        airports = db_manager.execute_query(query, db_path)
        ...
        airplanes = db_manager.execute_query(query, db_path)
    ...
    def add_airport(self, airport):
        ...
        BASE_DIR = os.path.dirname(os.path.abspath(__file__))
        img_path = os.path.join(BASE_DIR, "..", "GUI", "IMAGE", "map_marker.png")
        marker.set_source(img_path)
    ...
    def add_airplane(self, airplane):
        ...
        BASE_DIR = os.path.dirname(os.path.abspath(__file__))
        img_path = os.path.join(BASE_DIR, "..", "GUI", "IMAGE","airplane_marker.png")

        img = Image.open(img_path)

        rotated_img = img.rotate(-1 * airplane[4], resample=Image.BICUBIC, expand=True)
        BASE_DIR = os.path.dirname(os.path.abspath(__file__))
        img_path = os.path.join(BASE_DIR, "..", "GUI", "IMAGE", "{icao24:s}_airplane_marker.png")
        rotated_img.save(img_path.format(icao24=airplane[0]))

        marker.set_source(img_path.format(icao24=airplane[0]))
        self.add_widget(marker)  # Add the marker to the map.
    ...
    def add_collision(self, collision):
        ...
        BASE_DIR = os.path.dirname(os.path.abspath(__file__))
        img_path = os.path.join(BASE_DIR, "..", "GUI", "IMAGE", "collision_marker.png")

        img = Image.open(img_path)
        BASE_DIR = os.path.dirname(os.path.abspath(__file__))
        img_path = os.path.join(BASE_DIR, "..", "GUI", "IMAGE", "{icao24:s}_collision_marker.png")
        img.save(img_path.format(icao24=collision[0]))
        marker.set_source(img_path.format(icao24=collision[0]))
